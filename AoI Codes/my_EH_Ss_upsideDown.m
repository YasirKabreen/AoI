...
for i = 1:num_states
 ...
 % Sensor one transitions and rewards if it is not Not Sending and Conserving Energy:
    ...
    next_state22 = state;
        ...
        next_state21(2)=next_state21(2)+1;
  ...
  next_idx11 = find(ismember(state_space, next_state11, 'rows'));
    ...
    bb1=(next_state11(2)+next_state12(2)+next_state13(2)+next_state14(2))/4;
    bb2=(next_state21(2)+next_state22(2))/2;
    aa1=(next_state11(1)+next_state12(1)+next_state13(1)+next_state14(1))/4;
    aa2=(next_state21(1)+next_state22(1))/2;
