...
for i = 1:num_states
  ...
  next_state21 = state;
    ...
    R1(i) = 1/(next_state11(1)+next_state12(1)+next_state11(2)+next_state12(2))/4;
    R2(i) = 1/ (next_state21(1)+next_state22(1)+next_state21(2)+next_state22(2))/4;
    R3(i) = 1/ (next_state11(1)+next_state32(1)+next_state11(2)+next_state32(2))/4;
