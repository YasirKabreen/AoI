...
num_states = numel(AoI1_values) *  numel(AoI2_values) *  numel(B_level1) * numel(B_level2) ;
...
for i = 1:num_states
  ...
  if state(3)>=1 
        ...
        next_state11(2) = min(next_state11(2) + 1, max(AoI1_values));
      ...
      next_state12(2) = min(next_state12(2) + 1, max(AoI1_values));
    ...
    R1(i) = 1 /max(state(1),state(2));
    R2(i) = 1/max(state(1),state(2));
