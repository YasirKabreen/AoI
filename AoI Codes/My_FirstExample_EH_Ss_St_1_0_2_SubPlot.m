...
for k = 1:size(battery_combinations, 1)
    ...
    scatter(AoI1_selected(policy_selected == 1), AoI2_selected(policy_selected == 1), 'b', 'filled'); % Action 1 in red
    scatter(AoI1_selected(policy_selected == 2), AoI2_selected(policy_selected == 2), 'r', 'filled'); % Action 2 in blue
    scatter(AoI1_selected(policy_selected == 3), AoI2_selected(policy_selected == 3), 'g', 'filled'); % Action 3 in green
    scatter(AoI1_selected(policy_selected == 4), AoI2_selected(policy_selected == 4), 'k', 'filled'); % Action 3 in green
